...
const Sidebar = ({ navigations, classes, open }) => {
  return (
    <>
      <div
        className={twMerge(
          `mr-5 min-h-[80vh] w-72 border-r pr-2 dark:border-gray-600 md:w-80 ${classes} absolute bottom-0 top-0 z-50 bg-white py-3 pl-2 transition-all duration-200 dark:bg-gray-900 md:relative md:bottom-0 md:left-0 md:top-0 ${
